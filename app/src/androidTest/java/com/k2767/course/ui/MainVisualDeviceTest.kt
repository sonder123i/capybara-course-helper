...
class MainVisualDeviceTest {
    @Test fun captureLightDarkWallpaperNarrowLandscapeAndLargeText() {
        DemoUiDriver().use { ui ->
            ...
            try {
                ui.onMain { AppearanceSettingsManager.updateThemeMode(com.k2767.course.manager.AppThemeMode.System) }
                ...
                settle()
                capture("dark")
                ui.onMain { AppearanceSettingsManager.updateThemeMode(com.k2767.course.manager.AppThemeMode.Light) }
                settle()
