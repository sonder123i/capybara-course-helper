...
import com.k2767.course.ui.system.rememberPageData
...
import com.k2767.course.manager.SessionRequestTicket
import com.k2767.course.manager.SessionRequestGate
...
fun GradesRoute() {
    ...
    com.k2767.course.ui.system.ReportPageContent(semesterGrades.isNotEmpty() || overallGrades.isNotEmpty() || examList.isNotEmpty())
    GradesScreen(
