...
import com.k2767.course.demo.DemoData
import com.k2767.course.manager.CourseCacheManager
...
import com.k2767.course.ui.screen.toDynamicDisplayTags
import com.k2767.course.ui.route.SelectedCoursesRoute
import com.k2767.course.utils.CourseParser
import com.k2767.course.utils.CourseNameKit
...
private data class CourseListRouteSnapshot(
    ...
    val activeFilter: com.k2767.course.model.CourseFilter?,
    val draftFilter: com.k2767.course.model.CourseFilter,
...
private fun parseCourseTabParamsFromIndexHtml(html: String, indexParams: Map<String, String>): List<CourseTabParam> {
    ...
    return listOf(
        CourseTabParam(
            ...
            com.k2767.course.utils.CourseNameKit.resolveIndexXkkz(indexParams),
...
fun CourseListRoute() {
    ...
    if (!UserManager.getInstance().isDemoMode && academicSchool != null && com.k2767.course.academic.AcademicGatewayFactory.supports(academicSchool)) {
    ...
    val requests = remember { com.k2767.course.manager.SessionRequestGate(UserManager.getInstance().sessionState) }
    ...
    var draftFilter by remember(routeAccountKey) {
        mutableStateOf(restoredSnapshot?.draftFilter ?: com.k2767.course.model.CourseFilter())
    }
    ...
    com.k2767.course.ui.system.ReportPageContent(courses.isNotEmpty())
    ...
    // 筛选应用回调
    val onFilterApply: (com.k2767.course.model.CourseFilter) -> Unit = { filter ->
        activeFilter = filter
        showFilterPanel = false
        if (filter.isEmpty()) {
            courses = allCourses
    ...
    val onFilterClear: () -> Unit = {
        activeFilter = null
        draftFilter = com.k2767.course.model.CourseFilter()
        courses = allCourses
    }
    ...
    // 🔧 视图切换容器（带平滑动画）
    val topBarBackdrop = com.k2767.course.ui.system.LocalAppBackdrop.current
    val topBarUseGlass = topBarBackdrop != null && com.k2767.course.ui.system.isBackdropSupported()
    ...
    val screen = com.k2767.course.ui.system.rememberScreenMetrics()
    val topBarHeight = com.k2767.course.ui.system.TopBarLayoutMetrics.height()
    val topBarSegmentHeight = com.k2767.course.ui.system.TopBarLayoutMetrics.segmentHeight()
    ...
    val topBarSegmentWidth = com.k2767.course.ui.system.TopBarLayoutMetrics.segmentWidth()
    val topBarTint = if (com.k2767.course.ui.system.rememberGlassDarkTheme()) MaterialTheme.colorScheme.surface.copy(alpha = 0.9f) else White.copy(alpha = 0.60f)
    com.k2767.course.ui.theme.ReportStatusBarSurface(topBarTint)
    Scaffold(
        ...
        topBar = {
            ...
            Box(modifier = topBarShellModifier) {
                    ...
                    when (mode) {
                        "search" -> {
                            ...
                            Row(
                                ...
                                com.k2767.course.ui.system.GlassTextField(
                                    value = searchQuery,
                            ...
                            CenterAlignedTopAppBar(
                                ...
                                title = {
                                    ...
                                    Box(modifier = Modifier.padding(end = SegmentedPressSlack)) {
                                        com.k2767.course.ui.system.SystemSegmentedControl(
                                ...
                                actions = {
                                    ...
                                    com.k2767.course.ui.system.TopBarActionRail(
                                        spacing = 4.dp,
                                        ...
                                        action(
                                            ...
                                            com.k2767.course.ui.system.AnimatedLineIcon(
                                                com.k2767.course.ui.system.AnimatedIconSpec.Refresh,
                                                Modifier.size(com.k2767.course.ui.system.TopBarLayoutMetrics.IconSize),
                                                state = if (busy) com.k2767.course.ui.system.IconVisualState.Running
                                                    else com.k2767.course.ui.system.IconVisualState.Idle)
                                        }
                ...
                // 底部柔和渐变线（仅回退路径显示）
                if (!topBarUseGlass) {
                    com.k2767.course.ui.system.SystemDivider(alpha = 0.6f)
                }
                }
            }
            }
        ...
        Box(modifier = Modifier.fillMaxSize().padding(paddingValues).moduleEntrance(1)) {
            ...
            androidx.compose.animation.AnimatedVisibility(
                ...
                modifier = Modifier
                    ...
                    .padding(bottom = com.k2767.course.ui.system.LocalAppOverlayBottomInset.current),
                enter = slideInVertically { it * 2 } + fadeIn(),
                exit = slideOutVertically { it * 2 } + fadeOut()
            ) {
                com.k2767.course.ui.system.LiquidButton(
                    onClick = {
                    ...
                    style = com.k2767.course.ui.system.LiquidButtonStyle.SolidTinted,
...
internal fun FilterActionContent(activeCount: Int, expanded: Boolean, onAnchor: (androidx.compose.ui.geometry.Offset) -> Unit) {
    ...
    Box(modifier = Modifier.size(com.k2767.course.ui.system.TopBarLayoutMetrics.TouchTarget)
        .onGloballyPositioned { onAnchor(it.boundsInWindow().center) }, contentAlignment = Alignment.Center) {
        com.k2767.course.ui.system.AnimatedLineIcon(
            spec = com.k2767.course.ui.system.AnimatedIconSpec.Filter,
            state = if (expanded) com.k2767.course.ui.system.IconVisualState.Expanded else com.k2767.course.ui.system.IconVisualState.Idle,
            modifier = Modifier.size(com.k2767.course.ui.system.TopBarLayoutMetrics.IconSize),
            tint = if (active) NeuPrimary else androidx.compose.material3.LocalContentColor.current
        )
        com.k2767.course.ui.system.FilterCountBadge(activeCount,
...
private class CourseListLogicHelper(
    ...
    val requestSession: com.k2767.course.manager.SessionToken,
