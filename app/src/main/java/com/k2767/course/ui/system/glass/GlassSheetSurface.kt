...
fun Modifier.glassSheet(
    ...
    val surfaceColor = MaterialTheme.colorScheme.surface.copy(alpha = if (com.k2767.course.ui.system.rememberGlassDarkTheme())
        maxOf(material.surfaceAlpha, com.k2767.course.ui.system.LocalWallpaperAppearanceColors.current.surface.alpha) else material.surfaceAlpha)
