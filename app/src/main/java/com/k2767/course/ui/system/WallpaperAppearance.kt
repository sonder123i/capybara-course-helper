...
fun rememberWallpaperRegionAppearance(
    ...
    darkTheme: Boolean = com.k2767.course.ui.theme.LocalAppAppearance.current.isDark
    ...
    val toneMap = com.k2767.course.ui.theme.rememberAppWallpaperToneMap(darkTheme)
