...
import com.k2767.course.ui.system.GlassOpticsSpec

/*
 * 「圆钮压在自己轨道上」这一类控件在 API31/32 上的真折射参数。
 *
 * 三个控件共用（都是库 catalog 里 LiquidSlider 那一套配方逐参数搬过来的）：
 * - [com.k2767.course.ui.system.LiquidSwitch] 的旋钮（40×24 胶囊，纯色轨道）
 * - [com.k2767.course.ui.system.LiquidSlider] 的 thumb（40×24 胶囊，渐变轨道）
