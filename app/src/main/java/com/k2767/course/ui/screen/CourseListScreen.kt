...
import com.k2767.course.ui.system.GlassCircleButton
...
import com.k2767.course.academic.catalogGroupKey
import com.k2767.course.academic.catalogSelectionKey
...
import com.k2767.course.ui.system.SystemLoadingState
...
import com.k2767.course.ui.theme.MotionSpecs
...
fun CourseListScreen(
    ...
    activeFilter: com.k2767.course.model.CourseFilter? = null,
    draftFilter: com.k2767.course.model.CourseFilter = com.k2767.course.model.CourseFilter(),
    onDraftFilterChange: (com.k2767.course.model.CourseFilter) -> Unit = {},
    onFilterApply: () -> Unit = {},
    onFilterClear: () -> Unit = {},
    ...
    val reduceMotion = com.k2767.course.ui.system.rememberGlassAccessibilityMode().reduceMotion
...
private fun BoxScope.FilterPanelOverlay(
    ...
    val reduced = com.k2767.course.ui.system.rememberGlassAccessibilityMode().reduceMotion
    ...
    AnimatedVisibility(
        ...
        enter = fadeIn(animationSpec = tween(if (reduced) 0 else com.k2767.course.ui.theme.MotionProfile.IconMillis)) +
            scaleIn(
                initialScale = if (reduced) 1f else 0.96f,
                transformOrigin = origin,
                animationSpec = com.k2767.course.ui.theme.MotionProfile.hierarchySpring()
            ),
                ...
                Row(
                    ...
                    Row(
                        ...
                        if (onSetFuzzyMatchTarget != null && !hasSelected) {
                            com.k2767.course.ui.system.SystemIconButton(
                        ...
                        IconButton(onClick = onExpandClick, enabled = isDetailsReady && !isLoading) {
                            com.k2767.course.ui.system.AnimatedLineIcon(
                                com.k2767.course.ui.system.AnimatedIconSpec.Expand, Modifier.size(20.dp),
                                state = when {
                                    isLoading -> com.k2767.course.ui.system.IconVisualState.Running
                                    isExpanded -> com.k2767.course.ui.system.IconVisualState.Expanded
    ...
    Column(
        ...
        Row(
            ...
            if (course.isSelected) {
                ...
                if (showTargetAction) com.k2767.course.ui.system.SystemIconButton(
...
private fun ActiveFilterBar(
    filter: com.k2767.course.model.CourseFilter,
    filterCategories: List<CourseParser.FilterCategory>,
    onClear: () -> Unit,
    isLoading: Boolean
) {
 ...
 */
internal fun com.k2767.course.model.CourseFilter.toDynamicDisplayTags(
    filterCategories: List<CourseParser.FilterCategory>
): List<String> {
