...
public class UserManager {
    ...
    public com.k2767.course.manager.SessionToken saveCookieIfCurrent(
            com.k2767.course.manager.SessionToken expected, String cookie) {
        synchronized (sessionState) {
            if (!sessionState.isCurrent(expected) || cookie == null || cookie.isEmpty()) return null;
            saveCookie(cookie);
            com.k2767.course.manager.SessionToken installed = sessionState.getToken();
    ...
    public String deleteAccount(String accountKey) {
        ...
        if (appContext != null) {
            com.k2767.course.schedule.ScheduleReminderScheduler.get(appContext).clearAccount(storageKey);
        }
    ...
    private void installSession(boolean renewed) {
        ...
        try {
            ...
            if (runtimeSchool != null && (accountChanged || !address.equals(runtimeSchoolAddress))) {
                com.k2767.course.academic.AcademicGatewayFactory.INSTANCE.invalidate(runtimeSchool, runtimeAccountStorageKey);
            ...
            if (currentSchool != null && savedCookie != null && !savedCookie.isEmpty()) {
                ...
                if (com.k2767.course.academic.AcademicGatewayFactory.INSTANCE.supports(currentSchool)) {
                    com.k2767.course.academic.AcademicGatewayFactory.INSTANCE.importCookie(
    ...
    public void startDemoSession(SchoolConfig school) {
        ...
        selectedCourses = new ArrayList<>();
        isDemoMode = true;
        com.k2767.course.usage.UsageStatsManager.refreshEligibility();
        isLoggedIn = true;
