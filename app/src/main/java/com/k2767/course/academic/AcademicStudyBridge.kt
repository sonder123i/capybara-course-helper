...
object AcademicStudyBridge {
    fun reader(school: SchoolConfig, account: String, expected: com.k2767.course.manager.SessionToken = UserManager.getInstance().sessionState.token): AcademicStudyAdapter {
